...
const ProductTableRow = ({
  ...
  let formattedPrice = parseFloat(price.toFixed(2)).toFixed(2)
  return (
    <Tr className="intro-x">
      ...
      <Td className="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
        <span className="font-medium whitespace-nowrap">{product.description}</span>
      </Td>
      <Td className="first:rounded-l-md last:rounded-r-md  bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
        <span className="font-medium whitespace-nowrap">{formattedPrice}DA</span>
      </Td>
      <Td className="first:rounded-l-md last:rounded-r-md  bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
