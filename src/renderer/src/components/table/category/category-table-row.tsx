            ...
            <Tr className="intro-x">
                ...
                >
                    <div className="flex items-center justify-between ">
                        <div className="flex gap-1 items-end text-neutral-900 hover:cursor-pointer" onClick={handleEditButtonClick}>
                            <FaEdit className="text-neutral-900" size={30} strokeWidth={1.8} />
                            Edit
                        </div>
                        <div className="flex gap-1 items-end text-error hover:cursor-pointer" onClick={clickHandler}>
